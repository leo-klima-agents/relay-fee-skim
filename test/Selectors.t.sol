...
/// @notice Pins the two upstream selectors RelayFeeSkim depends on three ways: against literals,
...
contract SelectorsTest is Test {
    ...
    function test_selectors_keccak() public pure {
        // bytes4(keccak256(signature)) is the selector definition; the truncation is the point.
